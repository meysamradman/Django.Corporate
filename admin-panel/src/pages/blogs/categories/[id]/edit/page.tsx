...
export default function EditCategoryPage() {
  ...
  const {
    ...
    createMutationFn: async () => { }, // Not used
    updateMutationFn: (id, data) => blogApi.partialUpdateCategory(id, data),
    fetchQueryKey: ['blog-category', id],
    fetchQueryFn: () => blogApi.getCategoryById(Number(id)),
    invalidateQueryKeys: [['blog-categories-all'], ['blog-category', id]],
    onSuccessRedirect: "/blogs/categories",
    titleFieldName: "name",
  });
  ...
  if (isLoading) {
    return <div>Loading...</div>; // Or reusable skeleton
  }
