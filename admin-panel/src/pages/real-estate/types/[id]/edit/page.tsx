...
export default function EditPropertyTypePage() {
  ...
  const {
    ...
    fetchQueryKey: ['property-type', Number(id)],
    fetchQueryFn: () => realEstateApi.getTypeById(Number(id)),
    createMutationFn: (data) => realEstateApi.createType(data),
    updateMutationFn: (id, data) => realEstateApi.partialUpdateType(id, data),
    invalidateQueryKeys: [['property-types'], ['property-type', Number(id)]],
