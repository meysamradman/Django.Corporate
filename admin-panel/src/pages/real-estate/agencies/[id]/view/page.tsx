...
import { AgencyOverviewTab } from "@/components/real-estate/agencies/view/AgencyOverviewTab";
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="اطلاعات آژانس">
        <>
          <Button
            onClick={() => navigate(`/real-estate/agencies/${agencyId}/edit`)}
          >
            <Edit2 />
            ویرایش آژانس
          </Button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-6 gap-4">
        ...
        <div className="lg:col-span-4">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <AgencyOverviewTab agency={agencyData} />
          </Tabs>
        </div>
      </div>
    </div>
