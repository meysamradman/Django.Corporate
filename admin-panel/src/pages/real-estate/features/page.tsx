...
import { usePropertyFeatureColumns } from "@/components/real-estate/features/PropertyFeatureTableColumns";
import { usePropertyFeatureFilterOptions, getPropertyFeatureFilterConfig } from "@/components/real-estate/features/PropertyFeatureTableFilters";
...
export default function PropertyFeaturesPage() {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ['property-features', queryParams.search, queryParams.page, queryParams.size, queryParams.order_by, queryParams.order_desc, queryParams.is_active],
    queryFn: async () => {
