...
export default function EditTagPage() {
  ...
  const {
    ...
    id,
    isEditMode: true,
    fetchQueryKey: ['portfolio-tag', Number(id)],
    fetchQueryFn: () => portfolioApi.getTagById(Number(id)),
    createMutationFn: (data) => portfolioApi.createTag(data),
    updateMutationFn: (id, data) => portfolioApi.updateTag(id, data),
    invalidateQueryKeys: [['portfolio-tags'], ['portfolio-tag', Number(id)]],
