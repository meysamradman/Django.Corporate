export const PERMISSIONS = {
  ...
  REAL_ESTATE: {
    ...
    LISTING_TYPE_READ: 'real_estate.listing_type.read',
    LISTING_TYPE_CREATE: 'real_estate.listing_type.create',
    LISTING_TYPE_UPDATE: 'real_estate.listing_type.update',
    LISTING_TYPE_DELETE: 'real_estate.listing_type.delete',
