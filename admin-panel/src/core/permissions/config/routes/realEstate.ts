...
export const realEstateRoutes: RouteRule[] = [
  ...
  createRule({
    id: "listing-types",
    pattern: /^\/real-estate\/listing-types\/?$/,
    module: 'real_estate.listing_type',
    action: "read",
    description: "لیست وضعیت‌های ملک",
  }),
  createRule({
    id: "listing-type-create",
    pattern: /^\/real-estate\/listing-types\/create\/?$/,
    module: 'real_estate.listing_type',
    action: "create",
    description: "ایجاد وضعیت ملک",
  }),
  createRule({
    id: "listing-type-edit",
    pattern: new RegExp(`^/real-estate/listing-types/${ID_SEGMENT}/edit/?$`),
    module: 'real_estate.listing_type',
    action: "update",
