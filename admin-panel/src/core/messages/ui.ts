...
export const ACTION_MESSAGES = {
  ...
  selectFilesFirst: 'لطفا فایل‌ها را انتخاب کنید',
  noMediaDeletePermission: 'شما اجازه حذف رسانه‌ها را ندارید',
  uploadPermissionDenied: 'اجازه آپلود رسانه را ندارید',
  imageOnlyAllowed: 'فقط فایل‌های تصویری مجاز هستند',
  imageAdded: 'عکس با موفقیت اضافه شد',
  imageUploadFailed: 'خطا در آپلود عکس: {reason}',
  duplicateFilesIgnored: 'برخی از فایل‌های انتخابی تکراری بودند و نادیده گرفته شدند',
  maxTotalFilesLimit: 'حداکثر تعداد کل فایل‌های مجاز برای این بخش {max} عدد می‌باشد',
  maxSectionFilesLimit: 'در این بخش حداکثر {max} فایل می‌توان انتخاب کرد',
  filesUploadedCount: '{count} فایل با موفقیت آپلود شد',
  systemRolesNotDeletable: 'نقش‌های سیستمی قابل حذف نیستند',
  nonSystemRolesWillDelete: 'تنها {count} نقش غیرسیستمی حذف خواهد شد',
  downloadLinkUnavailable: 'لینک دانلود این رسانه در دسترس نیست',
  changesSaved: 'تغییرات با موفقیت ذخیره شد',
  changesSaveError: 'خطا در ذخیره تغییرات',
  addressLookupError: 'خطا در یافتن آدرس',
  activeStatusChanged: 'وضعیت فعال با موفقیت به {status} تغییر یافت',
  verifyStatusChanged: 'وضعیت تأیید با موفقیت به {status} تغییر یافت',
  activeStatusChangeError: 'خطا در تغییر وضعیت فعال',
  verifyStatusChangeError: 'خطا در تغییر وضعیت تأیید',
  dataLoadError: 'خطا در بارگذاری داده‌ها',
  rolesLoadFailed: 'بارگذاری نقش‌ها ناموفق بود',
  apiKeySaveError: 'خطا در ذخیره API key',
...
export const EXPORT_MESSAGES = {
  ...
  printPreparingAll: 'در حال آماده‌سازی فایل پرینت برای تمامی موارد...',
  printNoData: 'داده‌ای برای پرینت یافت نشد',
