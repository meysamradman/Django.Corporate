export const PERMISSION_TRANSLATIONS = {
  ...
  descriptions: {
    ...
    'View Property States': 'مشاهده وضعیت‌های ملک',
    'Create Property State': 'ایجاد وضعیت ملک',
    'Update Property State': 'ویرایش وضعیت ملک',
    'Delete Property State': 'حذف وضعیت ملک',
    'View Property Labels': 'مشاهده برچسب‌های ملک',
    'Create Property Label': 'ایجاد برچسب ملک',
    'Update Property Label': 'ویرایش برچسب‌های ملک',
    'Delete Property Label': 'حذف برچسب‌های ملک',
    ...
    'Update Property Tag': 'ویرایش تگ‌های ملک',
    'Delete Property Tag': 'حذف تگ‌های ملک',
    ...
    'Allow viewing property states': 'امکان مشاهده وضعیت‌های ملک',
    'Allow creating property states': 'امکان ایجاد وضعیت ملک',
    'Allow updating property states': 'امکان ویرایش وضعیت‌های ملک',
    'Allow deleting property states': 'امکان حذف وضعیت‌های ملک',
    'Allow viewing property labels': 'امکان مشاهده برچسب‌های ملک',
    'Allow creating property labels': 'امکان ایجاد برچسب ملک',
    'Allow updating property labels': 'امکان ویرایش برچسب‌های ملک',
    'Allow deleting property labels': 'امکان حذف برچسب‌های ملک',
