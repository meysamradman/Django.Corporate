export const PERMISSION_TRANSLATIONS = {
  ...
  descriptions: {
    ...
    'View Property Types': 'مشاهده انواع ملک',
    ...
    'Update Property Label': 'ویرایش برچسب ملک',
    'Delete Property Label': 'حذف برچسب ملک',
    ...
    'Allow viewing property types': 'امکان مشاهده انواع ملک',
    'Allow creating property types': 'امکان ایجاد نوع ملک',
    'Allow updating property types': 'امکان ویرایش انواع ملک',
    'Allow deleting property types': 'امکان حذف انواع ملک',
