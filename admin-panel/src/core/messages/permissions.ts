export const PERMISSION_TRANSLATIONS = {
  resources: {
    ...
    'Portfolio Category': 'دسته‌بندی نمونه‌کار',
    'Portfolio Tags': 'تگ‌های نمونه‌کار',
    'Portfolio Tag': 'تگ نمونه‌کار',
    'Portfolio Options': 'گزینه‌های نمونه‌کار',
    'Portfolio Option': 'گزینه‌های نمونه‌کار',
    ...
    'Agents': 'مشاوران',
    'Agencies': 'آژانس‌ها',
    'Property Types': 'نوع ملک',
    'Property Type': 'نوع ملک',
    'Property States': 'انواع معامله ملک',
    'Property State': 'نوع معامله ملک',
    'Property Labels': 'نشانه‌های ملک',
    'Property Label': 'نشانه ملک',
    ...
    'Edit Videos': 'ویرایش ویدیوها',
    'Edit Audio': 'ویرایش فایل‌های صوتی',
    'Edit Documents': 'ویرایش اسناد',
    'Delete Images': 'حذف تصاویر',
    'Delete Videos': 'حذف ویدیوها',
    'Delete Audio': 'حذف فایل‌های صوتی',
    'Delete Documents': 'حذف اسناد',
    'Upload All Media Types': 'آپلود همه انواع رسانه',
    ...
    'Manage Static Pages': 'مدیریت صفحات استاتیک',
    'Manage Panel Settings': 'مدیریت تنظیمات پنل',
  },
  ...
  descriptions: {
    ...
    'View Admins': 'مشاهده ادمین‌ها',
    'Allow viewing admin users list and details': 'امکان مشاهده لیست کاربران ادمین و جزئیات',
    'Create Admin': 'ایجاد ادمین',
    'Allow creating new admin users': 'امکان ایجاد کاربران ادمین جدید',
    'Update Admin': 'ویرایش ادمین',
    'Allow updating admin user information and profiles': 'امکان ویرایش اطلاعات و پروفایل کاربران ادمین',
    'Delete Admin': 'حذف ادمین',
    'Allow deleting admin users': 'امکان حذف کاربران ادمین',
    ...
    'Delete Documents': 'حذف اسناد',
    'Delete All Media Types': 'حذف همه انواع رسانه',
    'Manage Media Library': 'مدیریت کتابخانه رسانه',
    'Upload image files (jpg, png, webp, svg, gif)': 'آپلود فایل‌های تصویری (jpg, png, webp, svg, gif)',
    'Upload video files (mp4, webm, mov)': 'آپلود فایل‌های ویدیویی (mp4, webm, mov)',
    'Upload audio files (mp3, ogg, aac, m4a)': 'آپلود فایل‌های صوتی (mp3, ogg, aac, m4a)',
    'Upload PDF and document files': 'آپلود فایل‌های PDF و اسناد',
    'Upload any type of media file (images, videos, audio, documents)': 'آپلود هر نوع فایل رسانه‌ای (تصاویر، ویدیوها، صوتی، اسناد)',
    'Edit image metadata (title, alt, description)': 'ویرایش متادیتای تصاویر (عنوان، alt، توضیحات)',
    'Edit video metadata and cover image': 'ویرایش متادیتای ویدیوها و تصویر کاور',
    'Edit audio metadata and cover image': 'ویرایش متادیتای فایل‌های صوتی و تصویر کاور',
    'Edit document metadata and cover image': 'ویرایش متادیتای اسناد و تصویر کاور',
    'Edit metadata for any media type': 'ویرایش متادیتای هر نوع رسانه',
    'Delete image files (dangerous - may break content)': 'حذف فایل‌های تصویری (خطرناک - ممکن است محتوا را خراب کند)',
    'Delete video files (dangerous - may break content)': 'حذف فایل‌های ویدیویی (خطرناک - ممکن است محتوا را خراب کند)',
    'Delete audio files (dangerous - may break content)': 'حذف فایل‌های صوتی (خطرناک - ممکن است محتوا را خراب کند)',
    ...
    'Finalize Property Deal': 'نهایی‌سازی معامله ملک',
    'Delete Property': 'حذف ملک',
    'View Agents': 'مشاهده مشاوران',
    'Create Agent': 'ایجاد مشاور',
    'Update Agent': 'ویرایش مشاور',
    'Delete Agent': 'حذف مشاور',
    'View Agencies': 'مشاهده آژانس‌ها',
    'Create Agency': 'ایجاد آژانس',
    'Update Agency': 'ویرایش آژانس',
    'Delete Agency': 'حذف آژانس',
    'View Property Types': 'مشاهده نوع ملک',
    'Create Property Type': 'ایجاد نوع ملک',
    'Update Property Type': 'ویرایش نوع ملک',
    'Delete Property Type': 'حذف نوع ملک',
    'View Property States': 'مشاهده انواع معامله ملک',
    'Create Property State': 'ایجاد نوع معامله ملک',
    'Update Property State': 'ویرایش نوع معامله ملک',
    'Delete Property State': 'حذف نوع معامله ملک',
    'View Property Labels': 'مشاهده نشانه‌های ملک',
    'Create Property Label': 'ایجاد نشانه ملک',
    'Update Property Label': 'ویرایش نشانه‌های ملک',
    'Delete Property Label': 'حذف نشانه‌های ملک',
    'View Property Features': 'مشاهده ویژگی‌های ملک',
    'Create Property Feature': 'ایجاد ویژگی ملک',
    'Update Property Feature': 'ویرایش ویژگی‌های ملک',
    'Delete Property Feature': 'حذف ویژگی‌های ملک',
    'View Property Tags': 'مشاهده برچسب‌های ملک',
    'Create Property Tag': 'ایجاد برچسب ملک',
    'Update Property Tag': 'ویرایش برچسب‌های ملک',
    'Delete Property Tag': 'حذف برچسب‌های ملک',
    ...
    'Allow finalizing sold/rented deals for properties': 'امکان نهایی‌سازی معامله‌های فروخته/اجاره‌رفته برای املاک',
    'Allow deleting properties': 'امکان حذف املاک',
    'Allow viewing property agents list and details': 'امکان مشاهده لیست مشاوران و جزئیات',
    'Allow creating new property agents': 'امکان ایجاد مشاور جدید',
    'Allow updating property agents': 'امکان ویرایش مشاوران',
    'Allow deleting property agents': 'امکان حذف مشاوران',
    'Allow viewing real estate agencies list and details': 'امکان مشاهده لیست آژانس‌ها و جزئیات',
    'Allow creating new real estate agencies': 'امکان ایجاد آژانس جدید',
    'Allow updating real estate agencies': 'امکان ویرایش آژانس‌ها',
    'Allow deleting real estate agencies': 'امکان حذف آژانس‌ها',
    'Allow viewing property types': 'امکان مشاهده نوع ملک',
    'Allow creating property types': 'امکان ایجاد نوع ملک',
    'Allow updating property types': 'امکان ویرایش نوع ملک',
    'Allow deleting property types': 'امکان حذف نوع ملک',
    'Allow viewing property states': 'امکان مشاهده انواع معامله ملک',
    'Allow creating property states': 'امکان ایجاد نوع معامله ملک',
    'Allow updating property states': 'امکان ویرایش نوع معامله ملک',
    'Allow deleting property states': 'امکان حذف نوع معامله ملک',
    'Allow viewing property labels': 'امکان مشاهده نشانه‌های ملک',
    'Allow creating property labels': 'امکان ایجاد نشانه ملک',
    'Allow updating property labels': 'امکان ویرایش نشانه‌های ملک',
    'Allow deleting property labels': 'امکان حذف نشانه‌های ملک',
    'Allow viewing property features': 'امکان مشاهده ویژگی‌های ملک',
