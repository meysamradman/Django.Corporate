    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "لیست نوع معامله", url: "/real-estate/states", icon: Circle, access: { module: "real_estate.state", allowReadOnly: true } },
          { title: "ایجاد نوع معامله", onClick: () => useGlobalDrawerStore.getState().open(DRAWER_IDS.REAL_ESTATE_STATE_FORM), icon: Plus, access: { module: "real_estate.state", actions: ["create"] } },
