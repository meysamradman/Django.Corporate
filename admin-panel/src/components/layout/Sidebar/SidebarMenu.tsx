import {
  ...
  FilePlus,
  Building,
  MonitorPlay as GalleryHorizontal,
  DeviceMobile as Smartphone,
  GearSix as Settings2,
  ListChecks as ListTodo,
  BookBookmark as BookPlus,
  MusicNote as Music,
  Tray as Inbox,
    ...
    items: [
      {
        ...
        items: [
          ...
          { title: "برچسب‌های بلاگ", isTitle: true },
          { title: "لیست برچسب‌ها", url: "/blogs/tags", icon: Tag, access: { module: "blog.tag", allowReadOnly: true } },
          { title: "ایجاد برچسب", onClick: () => useGlobalDrawerStore.getState().open(DRAWER_IDS.BLOG_TAG_FORM), icon: Plus, access: { module: "blog.tag", actions: ["create"] } },
        ],
      },
      {
        title: "نمونه کار",
        ...
        items: [
          ...
          { title: "برچسب‌های نمونه کار", isTitle: true },
          { title: "لیست برچسب‌ها", url: "/portfolios/tags", icon: Tag, access: { module: "portfolio.tag", allowReadOnly: true } },
          { title: "ایجاد برچسب", onClick: () => useGlobalDrawerStore.getState().open(DRAWER_IDS.PORTFOLIO_TAG_FORM), icon: Plus, access: { module: "portfolio.tag", actions: ["create"] } },
      ...
      },
      {
        ...
        items: [
          ...
          { title: "نوع معامله ملک", isTitle: true },
          { title: "لیست نوع معامله", url: "/real-estate/listing-types", icon: Circle, access: { module: "real_estate.listing_type", allowReadOnly: true } },
          { title: "ایجاد نوع معامله", onClick: () => useGlobalDrawerStore.getState().open(DRAWER_IDS.REAL_ESTATE_LISTING_TYPE_FORM), icon: Plus, access: { module: "real_estate.listing_type", actions: ["create"] } },
          { title: "نشانه‌های ملک", isTitle: true },
          { title: "لیست نشانه‌ها", url: "/real-estate/labels", icon: Tag, access: { module: "real_estate.label", allowReadOnly: true } },
          { title: "ایجاد نشانه", onClick: () => useGlobalDrawerStore.getState().open(DRAWER_IDS.REAL_ESTATE_LABEL_FORM), icon: Plus, access: { module: "real_estate.label", actions: ["create"] } },
          ...
          { title: "لیست برچسب‌ها", url: "/real-estate/tags", icon: Tag, access: { module: "real_estate.tag", allowReadOnly: true } },
          { title: "ایجاد برچسب", onClick: () => useGlobalDrawerStore.getState().open(DRAWER_IDS.REAL_ESTATE_TAG_FORM), icon: Plus, access: { module: "real_estate.tag", actions: ["create"] } },
          { title: "لوکیشن", isTitle: true },
          { title: "لیست استان‌ها", url: "/real-estate/provinces", icon: MapIcon, access: { module: "real_estate.location", allowReadOnly: true } },
          { title: "لیست شهرها", url: "/real-estate/cities", icon: MapIcon, access: { module: "real_estate.location", allowReadOnly: true } },
          { title: "لیست مناطق", url: "/real-estate/regions", icon: MapIcon, access: { module: "real_estate.location", allowReadOnly: true } },
        ],
      },
      {
        title: "رسانه‌ها",
    ...
    items: [
      {
        ...
        items: [
          ...
          { title: "ایمیل‌های ارتباطی", url: "/settings/emails", icon: Mail },
          { title: "شبکه‌های اجتماعی", url: "/settings/social", icon: Share2 },
