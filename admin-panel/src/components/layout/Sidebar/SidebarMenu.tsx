    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "نمایندگان", isTitle: true },
          { title: "لیست نمایندگان", url: "/real-estate/agents", icon: UserCircle, access: { module: "property_agent", allowReadOnly: true } },
          { title: "ایجاد نماینده", url: "/real-estate/agents/create", icon: UserPlus, access: { module: "property_agent", actions: ["create"] } },
