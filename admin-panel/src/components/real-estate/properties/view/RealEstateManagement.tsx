        ...
        <Card className="overflow-hidden border-br shadow-3xs bg-card ring-1 ring-br/20">
            <CardContent className="p-0">
                <div className={`flex flex-col lg:flex-row divide-y lg:divide-y-0 lg:divide-x lg:divide-x-reverse divide-br/20 ${(!hasAgency || !hasAgentOrCreator) ? 'justify-center' : ''}`}>
                    {property.agency && (
                        <div className={`flex-1 p-2 ${!hasAgentOrCreator ? 'lg:px-16 lg:justify-center' : ''}`}>
                            <Item className="hover:bg-bg/5 transition-colors rounded-xl p-2 gap-4 border-none">
                                <ItemMedia className="size-14 rounded-xl bg-wt border border-br p-2.5 flex items-center justify-center shadow-3xs shrink-0 group-hover:border-blue-1/40 transition-all">
                                ...
                                <ItemActions>
                                    <Button
                                        ...
                                        className="size-9 rounded-xl text-blue-1/40 hover:text-blue-1 hover:bg-blue-1/10 border-none bg-transparent transition-colors shadow-none"
                                    >
                    ...
                    {(property.agent || property.created_by_name) && (
                        <div className={`flex-1 p-2 ${!hasAgency ? 'lg:px-16 lg:justify-center' : ''}`}>
                            <Item className="hover:bg-bg/5 transition-colors rounded-xl p-2 gap-4 border-none">
                                <ItemMedia className="relative shrink-0 size-14">
                                ...
                                <ItemContent className="min-w-0 flex-1">
                                    ...
                                    {(property.agent?.phone || (property as any).created_by_phone) ? (
                                        ...
                                        <span className="text-[10px] text-font-s/40 font-bold tracking-tight">بدون تماس</span>
                                    )}
                                </ItemContent>
                                ...
                                <ItemActions>
                                    <Button
                                        ...
                                        className="size-9 rounded-xl text-indigo-1/40 hover:text-indigo-1 hover:bg-indigo-1/10 border-none bg-transparent transition-colors shadow-none"
                                    >
                                        <ArrowUpRight className="size-5" />
                                    </Button>
                                </ItemActions>
