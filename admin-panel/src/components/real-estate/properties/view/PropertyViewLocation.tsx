...
export function PropertyViewLocation({ property }: PropertyViewLocationProps) {
    ...
    const isLocationEmpty = !hasLocation && !hasAddressInfo;
            ...
            <div className="flex flex-col gap-6">
                <div className="w-full">
                    <CardWithIcon
                        ...
                        contentClassName={isLocationEmpty ? "p-0" : ""}
                    >
                        {isLocationEmpty ? (
                            <EmptyState
                                title="اطلاعات مکانی ثبت نشده است"
                                description="آدرس یا موقعیت نقشه برای این ملک در دسترس نیست"
                                icon={MapPinOff}
                                size="sm"
                                fullBleed={true}
                            />
