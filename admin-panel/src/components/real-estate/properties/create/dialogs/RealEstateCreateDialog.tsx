...
export function RealEstateCreateDialog({
    ...
    const typeLabels = {
        ...
        state: { title: "افزودن نوع معامله جدید", desc: "یک نوع معامله جدید (مثلاً پیش‌فروش) اضافه کنید" },
        label: { title: "افزودن نشانه جدید", desc: "یک نشانه جدید (مثلاً فوری) اضافه کنید" },
        tag: { title: "افزودن برچسب جدید", desc: "یک برچسب جدید اضافه کنید" },
