...
import { useCreateAgencyPageTabs } from "@/components/real-estate/agencies/hooks/useCreateAgencyPageTabs";
...
export function CreateAgencyForm() {
  ...
  const createAgencyMutation = useMutation({
    mutationFn: async (data: AgencyFormValues) => {
      ...
      return realEstateApi.createAgency(agencyData as any);
    },
    onSuccess: () => {
      setFormAlert(null);
  ...
  const handleSubmit = async () => {
    ...
    createAgencyMutation.mutate(form.getValues());
  };
  ...
  const { tabs } = useCreateAgencyPageTabs({
    form,
