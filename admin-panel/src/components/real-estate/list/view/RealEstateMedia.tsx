    ...
    <div className="space-y-16">
          ...
          <div className="space-y-8">
            <div className="flex items-center justify-start gap-4 px-2">
              ...
              <div className="text-right">
                <h3 className="text-2xl font-black text-font-p">ویدیو و تیزر</h3>
                <p className="text-[10px] font-bold text-font-s opacity-50 uppercase tracking-widest mt-1">Video & Teasers</p>
              </div>
            </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch">
                      ...
                      <div className="flex-1 p-8 flex flex-col justify-center items-start text-right gap-4">
                        <div className="space-y-1 w-full">
                          <span className="text-[10px] font-black text-primary uppercase tracking-tighter">VIDEO ASSET</span>
        ...
        {audios.length > 0 && (
          <div className="space-y-8">
            <div className="flex items-center justify-start gap-4 px-2">
              ...
              <div className="text-right">
                <h3 className="text-2xl font-black text-font-p">توضیحات صوتی</h3>
                <p className="text-[10px] font-bold text-font-s opacity-50 uppercase tracking-widest mt-1">Audio assets</p>
              </div>
            </div>
                  ...
                  <div key={item.id} className="bg-wt border border-br rounded-[2.5rem] overflow-hidden shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_-12px_rgba(0,0,0,0.1)] transition-all duration-500">
                    <div className="p-8">
                      <div className="flex items-center justify-between mb-8">
                        <div className="text-right">
                          <span className="text-[10px] font-black text-pink-1 uppercase tracking-tighter">AUDIO ASSET</span>
                      ...
                      <div className="relative group/audio">
                        <div className="absolute inset-x-0 -top-4 bottom-0 bg-linear-to-b from-pink-1/5 to-transparent rounded-[2rem] opacity-0 group-hover/audio:opacity-100 transition-opacity" />
                        <MediaPlayer
                          media={media}
      ...
      {documents.length > 0 && (
        <div className="space-y-8 pt-8">
          <div className="flex items-center justify-start gap-4 px-2 border-t border-br pt-12">
            ...
            <div className="text-right">
              <h3 className="text-2xl font-black text-font-p">اسناد و مدارک فنی</h3>
              <p className="text-[10px] font-bold text-font-s opacity-50 uppercase tracking-widest mt-1">Property Documents</p>
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-100 bg-static-b/95 flex items-center justify-center animate-in fade-in duration-500">
          <div className="absolute top-0 inset-x-0 p-8 flex justify-between items-center z-50">
            <div className="flex flex-col items-start gap-1">
              <h2 className="text-lg font-black text-wt leading-none">{activeVideo?.title || 'Video Player'}</h2>
              <span className="text-[10px] font-bold text-wt/40 uppercase tracking-[0.2em] leading-none">Property Presentation</span>
            </div>
            <button
          ...
          <div className="w-full max-w-6xl px-4 animate-in zoom-in-95 duration-500">
            <div className="relative aspect-video bg-static-b rounded-[2rem] overflow-hidden shadow-2xl border border-wt/10">
