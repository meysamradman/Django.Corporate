                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-bg">
                            <div className="p-5">
                                ...
                                <span className="text-font-s text-xs text-font-s/70">#{property.id}</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-0 [&>div:not(:last-child)]:border-b [&>div:not(:last-child)]:border-br">
                            ...
                            <div className="flex items-center justify-between gap-3 py-3">
                                <div className="flex items-center gap-2">
                                    <Home className="w-4 h-4 text-font-s flex-shrink-0" />
                            ...
                            <div className="flex items-center justify-between gap-3 py-3">
                                <div className="flex items-center gap-2">
                                    <Maximize className="w-4 h-4 text-font-s flex-shrink-0" />
                            ...
                            <div className="flex items-center justify-between gap-3 py-3">
                                <div className="flex items-center gap-2">
                                    <BedDouble className="w-4 h-4 text-font-s flex-shrink-0" />
                            ...
                            <div className="flex items-center justify-between gap-3 py-3">
                                <div className="flex items-center gap-2">
                                    <Bath className="w-4 h-4 text-font-s flex-shrink-0" />
                            ...
                            <div className="flex items-center justify-between gap-3 py-3">
                                <div className="flex items-center gap-2">
                                    <DollarSign className="w-4 h-4 text-font-s flex-shrink-0" />
