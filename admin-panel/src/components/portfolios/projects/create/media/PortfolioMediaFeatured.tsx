...
interface PortfolioMediaFeaturedProps {
    currentFeaturedImage: Media | null;
    editMode: boolean;
    isMediaModalOpen: boolean;
    setIsMediaModalOpen: (open: boolean) => void;
    handleFeaturedImageSelect: (media: Media | Media[] | null) => void;
...
export function PortfolioMediaFeatured({
    ...
    return (
        <>
            <CardWithIcon
                ...
                cardBorderColor={hasError ? 'border-b-red-1' : 'border-b-indigo-1'}
