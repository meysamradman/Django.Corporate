...
interface PortfolioContentMainProps {
...
export function PortfolioContentMain({ form, formData, handleInputChange, editMode, isFormApproach }: PortfolioContentMainProps) {
