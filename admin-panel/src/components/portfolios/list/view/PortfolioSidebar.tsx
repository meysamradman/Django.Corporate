...
export function PortfolioSidebar({ portfolio }: PortfolioSidebarProps) {
  ...
  const [isActive, setIsActive] = useState(portfolio.is_active ?? (portfolio.status === "published"));
  ...
  const updatePublicMutation = useMutation({
    mutationFn: async (checked: boolean) => {
      return await portfolioApi.partialUpdatePortfolio(portfolio.id, { is_public: checked });
    },
    onSuccess: (data) => {
  ...
  const updateActiveMutation = useMutation({
    mutationFn: async (checked: boolean) => {
      return await portfolioApi.partialUpdatePortfolio(portfolio.id, { is_active: checked });
    },
    onSuccess: (data) => {
  ...
  const updateFeaturedMutation = useMutation({
    mutationFn: async (checked: boolean) => {
      return await portfolioApi.partialUpdatePortfolio(portfolio.id, { is_featured: checked });
    },
    onSuccess: (data) => {
