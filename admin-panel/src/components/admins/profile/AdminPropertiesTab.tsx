...
export function AdminPropertiesTab({ admin }: AdminPropertiesTabProps) {
  ...
  const { data: properties, isLoading, error } = useQuery({
    queryKey: ['properties', 'admin', admin.id, queryParams.search, queryParams.page, queryParams.size, queryParams.order_by, queryParams.order_desc, queryParams.created_by, queryParams.is_published, queryParams.is_featured, queryParams.is_active, queryParams.property_type, queryParams.state, queryParams.city],
    queryFn: async () => {
  ...
  const deletePropertyMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['properties', 'admin', admin.id] });
