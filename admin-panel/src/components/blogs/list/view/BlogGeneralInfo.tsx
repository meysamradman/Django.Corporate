...
export function BlogGeneralInfo({ blog }: GeneralInfoTabProps) {
                ...
                <div>
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: blog.description || "<p class='text-font-s'>توضیحی وارد نشده است</p>",
                    }}
                  />
                </div>
              </div>
          ...
          >
              ...
              <div className="space-y-3 pt-4 border-t">
                <div className="flex items-center justify-between">
                  ...
                  <Badge
                    variant={blog.status === "published" ? "green" : "outline"}
                  >
