...
export default function BlogDetailContent({ blog }: BlogDetailContentProps) {
  const description = typeof blog.description === "string" ? blog.description.trim() : "";
  ...
  return (
    <section className="overflow-hidden rounded-2xl border bg-card">
      <div className="border-b border-br/50 px-6 py-5">
        <h2 className="text-lg font-black text-font-p">متن مقاله</h2>
      </div>
