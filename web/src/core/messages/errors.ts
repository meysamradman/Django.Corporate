...
export const getError = createMessageGetter(ERROR_MESSAGES);
export const getNetworkError = createMessageGetter(NETWORK_ERROR_MESSAGES);
export const getHttpError = (code: number): string => HTTP_ERROR_MESSAGES[code] || NETWORK_ERROR_MESSAGES.unknown;
