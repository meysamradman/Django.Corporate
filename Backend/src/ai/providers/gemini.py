...
{{
    ...
    "content": "<h2>عنوان H2 اول</h2>\\n\\nپاراگراف اول محتوا که به موضوع H2 می‌پردازد...\\n\\n<h3>عنوان H3 اول</h3>\\n\\nپاراگراف زیرمجموعه H3...\\n\\n<h2>عنوان H2 دوم</h2>\\n\\nپاراگراف دوم...\\n\\nو به همین ترتیب. محتوای کامل باید حدود {word_count} کلمه باشد، شامل تگ‌های HTML <h2> و <h3> در جای مناسب، بهینه شده برای SEO، شامل کلمات کلیدی طبیعی، خوانا و جذاب.",
