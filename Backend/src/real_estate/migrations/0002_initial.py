...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='property',
            index=models.Index(fields=['city', 'property_type', 'bedrooms', 'bathrooms', '-price'], name='idx_main_filter'),
        ),
        migrations.AddIndex(
            model_name='property',
            index=models.Index(condition=models.Q(('is_active', True), ('is_public', True), ('is_published', True)), fields=['city', 'bedrooms', '-created_at'], name='idx_published_fast'),
        ),
        migrations.AddIndex(
            model_name='property',
            index=models.Index(condition=models.Q(('region__isnull', False)), fields=['city', 'region', 'neighborhood'], name='idx_region_search'),
        ),
        migrations.AddIndex(
            model_name='property',
            index=models.Index(condition=models.Q(('year_built__isnull', False)), fields=['city', 'year_built', '-price'], name='idx_year_filter'),
        ),
        migrations.AddIndex(
            model_name='property',
        ...
        migrations.AddIndex(
            model_name='property',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='idx_gin_search'),
        ),
        migrations.AddIndex(
            model_name='property',
            index=django.contrib.postgres.indexes.BrinIndex(fields=['created_at'], name='idx_brin_created', pages_per_range=64),
        ),
        migrations.AddIndex(
            model_name='property',
            index=django.contrib.postgres.indexes.BrinIndex(fields=['published_at'], name='idx_brin_published', pages_per_range=64),
        ),
        migrations.AddConstraint(
            model_name='property',
        ...
        migrations.AddConstraint(
            model_name='property',
            constraint=models.CheckConstraint(condition=models.Q(('bedrooms__gte', 0), ('bedrooms__lte', 10)), name='property_bedrooms_range'),
        ),
        migrations.AddConstraint(
            model_name='property',
            constraint=models.CheckConstraint(condition=models.Q(('bathrooms__gte', 0), ('bathrooms__lte', 5)), name='property_bathrooms_range'),
        ),
        migrations.AddConstraint(
            model_name='property',
            constraint=models.CheckConstraint(condition=models.Q(('parking_spaces__gte', 0), ('parking_spaces__lte', 10)), name='property_parking_range'),
        ),
        migrations.AddConstraint(
            model_name='property',
            constraint=models.CheckConstraint(condition=models.Q(('year_built__isnull', True), models.Q(('year_built__gte', 1300), ('year_built__lte', 1410)), _connector='OR'), name='property_year_built_range'),
        ),
        migrations.AddConstraint(
            model_name='property',
