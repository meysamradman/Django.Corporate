...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='region',
            name='city',
            field=models.ForeignKey(help_text='The city this region belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='regions', to='real_estate.city', verbose_name='City'),
        ),
        migrations.AddField(
            model_name='district',
            name='region',
            field=models.ForeignKey(help_text='The region this district belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='districts', to='real_estate.region', verbose_name='Region'),
        ),
        migrations.AddIndex(
            model_name='agentstatistics',
        ...
        migrations.AddIndex(
            model_name='region',
            index=models.Index(fields=['city', 'name'], name='real_estate_city_id_b46deb_idx'),
        ),
        migrations.AddIndex(
            model_name='region',
            index=models.Index(fields=['is_active', 'city'], name='real_estate_is_acti_bbd1cb_idx'),
        ),
        migrations.AddIndex(
            model_name='region',
            index=models.Index(fields=['latitude', 'longitude'], name='real_estate_latitud_28a7fe_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='region',
        ...
        migrations.AddIndex(
            model_name='district',
            index=models.Index(fields=['region', 'name'], name='real_estate_region__74ac7c_idx'),
        ),
        migrations.AddIndex(
            model_name='district',
            index=models.Index(fields=['is_active', 'region'], name='real_estate_is_acti_1bd5b8_idx'),
        ),
        migrations.AddIndex(
            model_name='district',
            index=models.Index(fields=['latitude', 'longitude'], name='real_estate_latitud_6a5b70_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='district',
