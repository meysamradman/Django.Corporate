    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ForeignKey(blank=True, help_text="Admin's profile picture from media library", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='admin_profiles', to='media.media', verbose_name='Profile Picture')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ForeignKey(blank=True, help_text="User's profile picture from media library", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_profiles', to='media.media', verbose_name='Profile Picture')),
