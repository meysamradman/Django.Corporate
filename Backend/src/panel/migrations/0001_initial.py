    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favicon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='panel_favicon', to='media.media')),
                ('logo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='panel_logo', to='media.media')),
            ],
            options={
