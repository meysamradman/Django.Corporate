    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, help_text='نام کشور (فعلاً فقط ایران)', max_length=100, unique=True, verbose_name='نام کشور')),
                ('code', models.CharField(db_index=True, help_text='کد ISO کشور (فعلاً فقط IRN برای ایران)', max_length=3, unique=True, verbose_name='کد کشور')),
                ('phone_code', models.CharField(blank=True, help_text='کد تلفن بین\u200cالمللی (مثلاً: +98 برای ایران)', max_length=5, verbose_name='کد تلفن')),
            ],
            options={
                'verbose_name': 'کشور',
