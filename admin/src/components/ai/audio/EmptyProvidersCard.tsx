        ...
        <Card>
            <CardContent className="py-8">
                <div className="text-center space-y-4">
                    <Mic className="h-12 w-12 mx-auto text-font-s mb-4" />
                    <h3 className="text-lg font-semibold mb-2">هیچ مدل AI فعالی برای تولید پادکست وجود ندارد</h3>
                    <div className="space-y-2 text-sm text-font-s">
                        <p>
                            برای تولید پادکست با AI، باید:
                        </p>
                        <ol className="list-decimal list-inside space-y-1 text-right" dir="rtl">
                            <li>به تب <strong>"تنظیمات AI"</strong> بروید</li>
                            <li>برای <strong>OpenAI</strong> API key وارد کنید</li>
